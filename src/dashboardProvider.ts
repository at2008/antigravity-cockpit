                ...
                <div class="header">
                    ...
                    <div class="header-actions">
                        <div class="header-top-buttons">
                            ...
                            <button class="blue" onclick="addAccount()">+ 添加新账号</button>
                        </div>
                        <div class="btn-group">
                    ...
                    function render() {
                        ...
                        accounts.forEach(acc => {
                            ...
                            if (acc.quota && !acc.quota.is_forbidden) {
                                ...
                                quotaHtml = \`
                                    <div style="text-align:center; padding: 40px; background: rgba(248, 113, 113, 0.05); border-radius: 12px; border: 1px dashed #f87171; color: #f87171; margin-top:20px;">
                                        <div style="font-size: 24px; margin-bottom:10px;">⚠️</div>
                                        <div>暂无配额数据 (Token失效或权限受限)</div>
                                    </div>\`;
                            }
                            ...
                            panel.innerHTML = \`
                                ...
                                \${quotaHtml}
                                <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid var(--border-color); display:flex; justify-content: flex-end;">
                                    <button class="secondary" style="color: #ef4444; opacity: 0.7;" onclick="deleteAccount('\${acc.id}', '\${acc.email}')">🗑️ 移除此账号</button>
                                </div>
                            \`;
