                ...
                <div class="header">
                    ...
                    <div class="header-bottom-row">
                        <div class="header-actions">
                            <button class="purple" onclick="openGroupManager()">分组管理</button>
                            ...
                            tr.innerHTML = \`
                                ...
                                <td style="text-align: right;">
                                    <div class="btn-group" style="justify-content: flex-end;">
                                        \${!acc.isCurrent ? \`<button class="purple" onclick="switchAccount('\${acc.id}', '\${acc.email}')">切换</button>\` : '<span style="font-size:12px;color:#4ade80;margin-right:10px;">使用中</span>'}
                                        <button class="secondary" onclick="refreshAccount('\${acc.id}')">刷新</button>
                                        <button class="danger" onclick="deleteAccount('\${acc.id}', '\${acc.email}')">删除</button>
                                    </div>
                                </td>
                            \`;
