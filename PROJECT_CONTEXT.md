...
- **2026-01-20 16:15**: 修复 SwitcherProxy v10 Windows 兼容性 bug。通过更正 VBScript 路径转义，成功打通“退出->注入->重启”完整闭环。
- **2026-01-16 00:35**: 实现首次安装默认分组功能：分组为空时自动创建 "Group1" 并包含所有模型。
- **2026-01-15 20:51**: 完成 VS Code 插件发布与自动化部署 (v0.1.4)；配置 GitHub/Azure DevOps 双平台同步。
- **2026-01-15 18:52**: README 全面更新以反映 SwitcherProxy v10 功能；优化 OAuth 链路显示。
